...
from pipeline.code.logging_setup import setup_logger, utc_stamp
...
from pipeline.code.plover_client import PloverClient
...
def info() -> InfoResponse:
    ...
    cfg = app.state.cfg
    from pipeline.code.config import load_questions
